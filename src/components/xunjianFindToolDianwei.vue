  ...
  <div class="xunjian_find_wrap">
    <div style="display: flex">
      ...
      <ul>
        ...
        <li v-if="false" @click="save"><img src="../../static/images/save.png" alt=""><span>保存</span></li>
        <li v-if="false" @click="delTaskTable"><img src="../../static/images/remove.png" alt=""><span>删除</span></li>
